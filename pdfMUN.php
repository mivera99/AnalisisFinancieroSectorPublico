    ...
    <h3>Ingresos (en €)</h3><span style="text-align:left"><table cellspacing="0" cellpadding="5" border="1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getImpuestosDirectos1(), 2, ",",".") . '</td>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getImpuestosIndirectos1(), 2, ",",".") . '</td>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getTasasPreciosOtros1(), 2, ",",".") . '</td>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getTransferenciasCorrientes1(), 2, ",",".") . '</td>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getIngresosPatrimoniales1(), 2, ",",".") . '</td>
            </tr>
            <tr>
                ...
                <th style="width:110">' . number_format($mun2021->getTotalIngresosCorrientes1(), 2, ",",".") . '</th>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getEnajenacionInversionesReales1(), 2, ",",".") . '</td>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getTransferenciasCapital1(), 2, ",",".") . '</td>
            </tr>
            <tr>
                ...
                <th style="width:110">' . number_format($mun2021->getTotalIngresosNoCorrientes1(), 2, ",",".") . '</th>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getActivosFinancieros1(), 2, ",",".") . '</td>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getPasivosFinancieros1(), 2, ",",".") . '</td>
            </tr>
            <tr>
                ...
                <th style="width:110">' . number_format($mun2021->getTotalIngresos1(), 2, ",",".") . '</th>
            </tr>
        </tbody>
    ...
    <h3>Gastos (en €)</h3><span style="text-align:left"><table cellspacing="0" cellpadding="5" border="1">
        ...
        <tbody>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getGastosPersonal1(), 2, ",",".") . '</td>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getGastosCorrientesBienesServicios1(), 2, ",",".") . '</td>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getGastosFinancieros1(), 2, ",",".") . '</td>
            </tr>
            <tr>
                <td style="width:300">4. Transferencias Corrientes</td>
                ...
                <td style="width:110">' . number_format($mun2021->getTransferenciasCorrientesGastos1(), 2, ",",".") . '</td>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getFondoContingencia1(), 2, ",",".") . '</td>
            </tr>
            <tr>
                ...
                <th style="width:110">' . number_format($mun2021->getTotalGastosCorrientes1(), 2, ",",".") . '</th>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getInversionesReales1(), 2, ",",".") . '</td>
            </tr>
            <tr>
                <td style="width:300">7. Transferencias de capital</td>
                ...
                <td style="width:110">' . number_format($mun2021->getTransferenciasCapitalGastos1(), 2, ",",".") . '</td>
            </tr>
            <tr>
                ...
                <th style="width:110">' . number_format($mun2021->getTotalGastosNoFinancieros1(), 2, ",",".") . '</th>
            </tr>
            <tr>
                <td style="width:300">8. Activos Financieros</td>
                <td style="width:110">' . number_format($mun2019->getActivosFinancieros1(), 2, ",",".") . '</td>
                <td style="width:110">' . number_format($mun2020->getActivosFinancieros1(), 2, ",",".") . '</td>
                <td style="width:110">' . number_format($mun2021->getActivosFinancierosGastos1(), 2, ",",".") . '</td>
            </tr>
            <tr>
                <td style="width:300">9. Pasivos Financieros</td>
                ...
                <td style="width:110">' . number_format($mun2021->getPasivosFinancierosGastos1(), 2, ",",".") . '</td>
            </tr>
            <tr>
                ...
                <th style="width:110">' . number_format($mun2021->getTotalGastos1(), 2, ",",".") . '</th>
            </tr>
        </tbody>
    </table>
    </span>
...
$html .= '
    <br><br>
    <h3>Endeudamiento</h3>
    <b>Deuda Financiera 2021: </b>' . number_format($mun2021->getDeudaFinanciera(), 2, ",",".") . "€" . '
    <br><b>Deuda Financiera 2020: </b>' . number_format($mun2020->getDeudaFinanciera(), 2, ",",".") . "€" . '<br>
    <br><span style="text-align:left"><table cellspacing="0" cellpadding="5" border="1">
        ...
        <tbody>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getEndeudamiento()*100, 2, ",",".") . "%" . '</td>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getEndeudamientoMediaDiputaciones()*100, 2, ",",".") . "%" . '</td>
            </tr>
        </tbody>
    </table>
    </span>
    ...
    <br><span style="text-align:left"><table cellspacing="0" cellpadding="5" border="1">
        ...
        <tbody>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getSostenibilidadFinanciera()*100, 2, ",",".") . "%" . '</td>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getSostenibilidadFinancieraMediaDiputaciones()*100, 2, ",",".") . "%" . '</td>
            </tr>
        </tbody>
    </table>
    <br><br><span style="text-align:left"><table cellspacing="0" cellpadding="5" border="1">
        ...
        <tbody>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getApalancamientoOperativo()*100, 2, ",",".") . "%" . '</td>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getApalancamientoOperativoMediaDiputaciones()*100, 2, ",",".") . "%" . '</td>
            </tr>
        </tbody>
    </table>
    <br><br><span style="text-align:left"><table cellspacing="0" cellpadding="5" border="1">
        ...
        <tbody>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getSostenibilidadDeuda()*100, 2, ",",".") . "%" . '</td>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getSostenibilidadDeudaMediaDiputaciones()*100, 2, ",",".") . "%" . '</td>
            </tr>
        </tbody>
    </table>
    </span>
...
$html = '
    ...
    <span style="text-align:justify;">
    <h3>Liquidez</h3>
    <b>Fondos líquidos 2021: </b>' . number_format($mun2021->getFondosLiquidos(), 2, ",",".") . "€" . '
    <br><b>Fondos líquidos 2020: </b>' . number_format($mun2020->getFondosLiquidos(), 2, ",",".") . "€" . '
    <br><br><span style="text-align:left"><table cellspacing="0" cellpadding="5" border="1">
        <thead>
            <tr>
                <th style="width:410"></th>
        ...
        <tbody>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getRemanenteTesoreriaGastosGenerales()*100, 2, ",",".") . "%" . '</td>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getRemanenteTesoreriaGastosGeneralesMediaDiputaciones()*100, 2, ",",".") . "%" . '</td>
            </tr>
        </tbody>
    </table>
    <br><br><span style="text-align:left"><table cellspacing="0" cellpadding="5" border="1">
        ...
        <tbody>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getLiquidezInmediata()*100, 2, ",",".") . "%" . '</td>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getSolvenciaCortoPlazoMediaDiputaciones()*100, 2, ",",".") . "%" . '</td>
            </tr>
        </tbody>
    </table>
    <br><br><span style="text-align:left"><table cellspacing="0" cellpadding="5" border="1">
        ...
        <tbody>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getSolvenciaCortoPlazo()*100, 2, ",",".") . "%" . '</td>
            </tr>
            <tr>
                <th style="width:410">Solvencia Corto Plazo Media Ayuntamientos</th>
                <td style="width:110">' . number_format($mun2020->getSolvenciaCortoPlazoMediaDiputaciones2()*100, 2, ",",".") . "%" . '</td>
                <td style="width:110">' . number_format($mun2021->getSolvenciaCortoPlazoMediaDiputaciones2()*100, 2, ",",".") . "%" . '</td>
            </tr>
        </tbody>
    </table>
    </span>
    ...
    <br><span style="text-align:left"><table cellspacing="0" cellpadding="5" border="1">
        ...
        <tbody>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getEficiencia()*100, 2, ",",".") . "%" . '</td>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getEficienciaMediaDiputaciones()*100, 2, ",",".") . "%" . '</td>
            </tr>
        </tbody>
    </table>
    </span>
    ...
    <br><span style="text-align:left"><table cellspacing="0" cellpadding="5" border="1">
        ...
        <tbody>
            <tr>
                ...
                <td style="width:110">' .number_format($mun2021->getEjecucionIngresosCorrientes()*100, 2, ",",".") . "%" . '</td>
            </tr>
            <tr>
                ...
                <td style="width:110">' .number_format($mun2021->getEjecucionIngresosCorrientesMediaDiputaciones()*100, 2, ",",".") . "%" . '</td>
            </tr>
        </tbody>
    </table>
    <br><br><span style="text-align:left"><table cellspacing="0" cellpadding="5" border="1">
        ...
        <tbody>
            <tr>
                ...
                <td style="width:110">' .number_format($mun2021->getEjecucionGastosCorrientes()*100, 2, ",",".") . "%" . '</td>
            </tr>
            <tr>
                ...
                <td style="width:110">' .number_format($mun2021->getEjecucionGastosCorrientesMediaDiputaciones()*100, 2, ",",".") . "%" . '</td>
            </tr>
        </tbody>
    </table>
    </span>
...
$html = '
    ...
    <b>Deuda Comercial 2021: </b>' . number_format($mun2021->getDeudaComercial(), 2, ",",".") . "€" . '
    <br><b>Deuda Comercial 2020: </b>' . number_format($mun2020->getDeudaComercial(), 2, ",",".") . "€" . '
    <br><br><span style="text-align:left"><table cellspacing="0" cellpadding="5" border="1">
        <thead>
            <tr>
            <th style="width:410"></th>
        ...
        <tbody>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getPeriodoMedioPagos(), 2, ",",".") . " días" . '</td>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getPeriodoMedioPagosMediaDiputaciones(), 2, ",",".") . " días" . '</td>
            </tr>
        </tbody>
    </table>
    <br><br><span style="text-align:left"><table cellspacing="0" cellpadding="5" border="1">
        ...
        <tbody>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getPagosSobreObligacionesReconocidas()*100, 2, ",",".") . "%" . '</td>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getPagosSobreObligacionesReconocidasMediaDiputaciones()*100, 2, ",",".") . "%" . '</td>
            </tr>
        </tbody>
    </table>
    </span>
...
$html .= '
    ...
    <b>Derechos Pendientes de Cobro 2021: </b>' . number_format($mun2021->getDerechosPendientesCobro(), 2, ",",".") . "€" . '
    <br><b>Derechos Pendientes de Cobro 2020: </b>' . number_format($mun2020->getDerechosPendientesCobro(), 2, ",",".") . "€" . '
    <br><br><span style="text-align:left"><table cellspacing="0" cellpadding="5" border="1">
        <thead>
            <tr>
            <th style="width:410"></th>
        ...
        <tbody>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getEficaciaRecaudatoria()*100, 2, ",",".") . "%" . '</td>
            </tr>
            <tr>
                ...
                <td style="width:110">' . number_format($mun2021->getEficaciaRecaudatoriaMediaDiputaciones()*100, 2, ",",".") . "%" . '</td>
            </tr>
        </tbody>
    </table>
';
